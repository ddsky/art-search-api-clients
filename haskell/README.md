## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Art Search API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Art Search API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | ArtSearch                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | art-search                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | ArtSearchConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | ArtSearchRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| ArtSearch.Client    | use the "dispatch" functions to send requests       |
| ArtSearch.Core      | core functions, config and request types            |
| ArtSearch.API       | construct api requests                              |
| ArtSearch.Model     | describes api models                                |
| ArtSearch.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| ArtSearch.ModelLens | lenses for model fields                             |
| ArtSearch.Logging   | logging functions and utils                         |
