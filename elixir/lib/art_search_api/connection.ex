...
defmodule ArtSearchAPI.Connection do
  @moduledoc """
  Handle Tesla connections for ArtSearchAPI.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, ArtSearchAPI.Connection,
        base_url: "https://api.artsearch.io",
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:artsearch, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - ArtSearchAPI 1.0.0 - elixir"
        )
      )
